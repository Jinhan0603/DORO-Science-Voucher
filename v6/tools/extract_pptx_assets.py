...
from assembly_source_config import ASSEMBLY_REFERENCE_DIR, KIT_CONFIGS, V5_ROOT


DATA_DIR = V5_ROOT / "assets" / "data"
PARTS_DIR = V5_ROOT / "assets" / "images" / "parts"
ASSEMBLY_DIR = V5_ROOT / "assets" / "images" / "assembly"
...
def extract_kit_assets(kit_id: str, config: dict) -> dict:
        ...
        generated_steps.append(
            {
                ...
                "asset": step_file.relative_to(V5_ROOT).as_posix(),
            }
        )
    ...
    return {
        ...
        "partsOverview": overview_path.relative_to(V5_ROOT).as_posix(),
