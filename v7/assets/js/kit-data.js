/* DORO Science Voucher V7 Kit Data */
window.DORO_KIT_DATA = {
  "1-bluetooth-speaker": {
    ...
    parts: [
      ...
      { id: "battery-holder", name: "건전지 홀더", icon: "battery", image: "../../assets/images/parts/1-bluetooth-speaker/battery-holder.jpg", alt: "건전지 홀더 사진", role: "건전지를 넣어 스피커에 전기를 보내는 통이에요.", check: "+, - 표시가 있는 검은 홀더를 찾아요." },
      { id: "batteries", name: "건전지 4개", icon: "battery", image: "../../assets/images/parts/1-bluetooth-speaker/batteries.jpg", alt: "건전지 4개 사진", role: "스피커가 켜지도록 전기를 보내는 건전지예요.", check: "같은 크기의 건전지 네 개를 찾아요." },
