/* ============================================
   ...
   Covers: index.html + all 6 program pages (full)
   ============================================ */
...
const i18n = {
  ko: {
    ...
    // TOC Sidebar
    'prog.toc.photos': '키트 사진',
    'prog.toc.checklist': '준비물',
    'prog.toc.missions': '교육 과정',
    'prog.toc.media': '데모 영상',
    'prog.toc.ai': 'AI 확장',
    'prog.toc.faq': 'FAQ',
    ...
    'p1.step1.title': '왜 이 키트를 배우는가 — 도입',
    'p1.step2.title': '오늘의 과학 개념',
    'p1.step3.title': '조립 — 판다 스피커 만들기',
    'p1.step4.title': '작동 확인 + 소리 탐구',
    ...
    'p2.step1.title': '도입 — 빛과 센서의 세계',
    'p2.step2.title': '과학 개념 — 회로와 센서',
    'p2.step3.title': '조립 — 고양이 무드등 제작',
    'p2.step4.title': '작동 확인 + 탐구',
    ...
    'p3.step1.title': '도입 — 어떻게 걷는가?',
    'p3.step2.title': '과학 개념 — 기구학과 모터',
    'p3.step3.title': '조립 — 강아지 로봇 제작',
    'p3.step4.title': '작동 + 탐구',
    ...
    'p4.step1.title': '도입 — 자동차가 스스로 움직이다?',
    'p4.step2.title': '과학 개념 — IR 센서와 거리 측정',
    'p4.step3.title': '조립 — DORO 로봇 자동차 제작',
    'p4.step4.title': '작동 + 탐구',
    ...
    'p5.step1.title': '도입 — 게임기의 원리',
    'p5.step2.title': '과학·코딩 개념',
    'p5.step3.title': '조립 — 게임기 제작',
    'p5.step4.title': '코딩 — 러닝 점프 게임 만들기',
    ...
    'p6.step1.title': '도입 — 손이 악기가 되다',
    'p6.step2.title': '과학·코딩 개념',
    'p6.step3.title': '조립 — 개구리 피아노 제작',
    'p6.step4.title': '코딩 — 거리-음 매핑',
  ...
  en: {
    ...
    'hero.tagline4': 'You are the only one who can bring it back.',
    ...
    'dimc.card1.desc': 'Sensors, circuits, kinematics — experience textbook science by building it yourself',
    'dimc.card2.title': 'Making Experience',
    'dimc.card2.desc': 'Students lead the full process: design, assemble, and verify',
    ...
    'prog.checklist.title': '🔧 Materials Checklist',
    ...
    // TOC Sidebar
    'prog.toc.photos': 'Kit Photos',
    'prog.toc.checklist': 'Materials',
    'prog.toc.missions': 'Curriculum',
    'prog.toc.media': 'Demo Video',
    'prog.toc.ai': 'AI Extension',
    'prog.toc.faq': 'FAQ',
    ...
    'p1.step1.title': 'Introduction — Why This Kit?',
    'p1.step2.title': 'Science Concepts',
    'p1.step3.title': 'Assembly — Build the Panda Speaker',
    'p1.step4.title': 'Test & Sound Exploration',
    ...
    'p2.step1.title': 'Intro — The World of Light & Sensors',
    'p2.step2.title': 'Science — Circuits & Sensors',
    'p2.step3.title': 'Assembly — Build the Cat Mood Light',
    'p2.step4.title': 'Test & Explore',
    ...
    'p3.step1.title': 'Intro — How Do We Walk?',
    'p3.step2.title': 'Science — Kinematics & Motors',
    'p3.step3.title': 'Assembly — Build the Dog Robot',
    'p3.step4.title': 'Test & Explore',
    ...
    'p4.step1.title': 'Intro — Cars That Drive Themselves?',
    'p4.step2.title': 'Science — IR Sensors & Distance',
    'p4.step3.title': 'Assembly — Build the DORO Robot Car',
    'p4.step4.title': 'Test & Explore',
    ...
    'p5.step1.title': 'Intro — How Game Consoles Work',
    'p5.step2.title': 'Science & Coding Concepts',
    'p5.step3.title': 'Assembly — Build the Game Console',
    'p5.step4.title': 'Coding — Build the Running Jump Game',
    ...
    'p6.step1.title': 'Intro — Your Hand Is the Instrument',
    'p6.step2.title': 'Science & Coding Concepts',
    'p6.step3.title': 'Assembly — Build the Frog Piano',
    'p6.step4.title': 'Coding — Distance-Pitch Mapping',
